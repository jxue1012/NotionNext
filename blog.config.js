...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ein', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '独立游戏设计师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-eta-vert.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Individual Blog', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'j.xue0402@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  WIDGET_PET_LINK:
    ...
    'https://notion-next-eta-vert.vercel.app/about', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
